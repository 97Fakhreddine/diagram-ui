...
class Graphics extends Component {
  ...
  handleMouseOver = (event) => {
    ...
    const pos = this.refs.graphicStage.getPointerPosition();
    ...
    arrows.map((eachArrow) => {
      if (eachArrow.name === this.state.newArrowRef) {
        const index = arrows.indexOf(eachArrow);
            ...
            >
              <Toolbar
                ...
                appendToStars={(stuff) => {
                  ...
                  const toPush = stuff;
                  const stage = this.refs.graphicStage;
                  const transform = this.refs.layer2
                    .getAbsoluteTransform()
                    .copy();
                  transform.invert();
                ...
                appendToTexts={(stuff) => {
                  ...
                  const text = stage.findOne('.' + toPush.name);
                  //   const text = this.refs[toPush.ref.toString()];
                  console.log(stage);
                  console.log(text);
